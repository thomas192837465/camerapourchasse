...
/**
 * Crée un panier Shopify et renvoie son URL de paiement hébergée (checkoutUrl).
 * lines : [{ variantId: "gid://shopify/ProductVariant/...", quantity }]
 */
export async function createShopifyCheckoutUrl(lines) {
  const data = await shopifyFetch(
